            ...
            <div class="container">
                ...
                <div class="contact-content ">
                    ...
                    <div class="contact-form-area ">
                        <form action="SubmitNews" style="width: 100%">
                           
                            <div class="form-group">
                                <!--                                   <input type="text" class="form-control" id="Categoria" name="Categoria" placeholder="Categoria">-->
                                <select  class="form-control" name="op" value="${item.getCategoria()}">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" name="message" id="message" cols="2" rows="2" value="${item.getTitle()}"></textarea>
                            </div>
                             <div class="form-group">
                                 <input type="text" class="form-control" id="time" name="sumary" value="${item.getSumary()}">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="customFile">Upload Image</label>
                                <input type="file" class="form-control" id="customFile" name="image" value="${item.getUrlImage()}" />
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" name="content" id="message" cols="30" rows="10" value="${item.getContent()}"></textarea>
                            </div>
