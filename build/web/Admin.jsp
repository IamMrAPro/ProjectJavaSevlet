                                    ...
                                    <div class="classynav">
                                        <ul>
                                            ...
                                            <li><a href="#">Pages</a>
                                                <ul class="dropdown">
                                                    <li><a href="home">Home</a></li>
                                                    <li><a href="tranf">Update Author</a></li>
                            ...
                            <div class="row">
                                <form method="get" action="accept">
                                    ...
                                    <c:if test="${!list.isEmpty()}">
                                        <h1 style="text-align: center">News don't accepted</h1>
                                    </c:if>
                                    <c:forEach items="${list}" var="item">
                                        ...
                                        <div class="col-12 col-md-4">
                                            ...
                                            <div  class="post-content">
                                                ...
                                                <input type="submit" name="accpept" class="dropdown-item post-title" value="Accept" >


                                                <input name="accpept" type="submit" class="dropdown-item post-title" value="Delete" >
                                        ...
                                        <h1 style="text-align: center">News accepted</h1>
                                    <c:forEach items="${lists}" var="item">
                                        ...
                                        <div class="col-12 col-md-4">
                                            ...
                                            <div  class="post-content">
                                                ...
                                                <input type="submit" name="accpept" class="dropdown-item post-title" value="UnAccept" >


                                                <input name="accpept" type="submit" class="dropdown-item post-title" value="Delete this news" >
